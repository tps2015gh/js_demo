 ...
 *  @since 2018-11-28
 */
var add_div_html = function(html  ,className  ){
    /** @type {HTMLDivElement} e */
    var e = document.createElement("div");
    //   e.style.border = "1px solid red";
    e.innerHTML = html 
 ...
 *  @since 2018-11-28
 */
var add_span_html = function(html  ,className  ){
    /** @type {HTMLDivElement} e */
 ...
 */
var add_NAV = function(links , texts , active_index ,style){
 ...
 * @param {number} active_index 
 */
var add_NAV_DEFAULT = function(sitename, siteurl ,  links , texts , active_index){
    var nav = spell_element("nav","navbar navbar-expand-sm bg-light navbar-light")
    ...
    */
    ...
    nav_hd.setAttribute("href",siteurl)
    nav_hd.text = sitename ; // +"//" +  siteurl 
 ...
 * @param {string} file 
 */
function add_css( path, file){
    /** @type {HTMLLinkElement} css */
    var css   = document.createElement("link")
    css.setAttribute("rel", "stylesheet")
    css.setAttribute("href", path + file )
    return css 

}

function adddom_Bootstrap4_CDN(){
    /** @type {HTMLHeadElement}  hd  */
    var hd =  document.head
    var lst = [] 
    lst[lst.length] = add_css("https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/","bootstrap.min.css")
    lst[lst.length] = add_script("https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/","jquery.min.js")
    lst[lst.length] = add_script("https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/","popper.min.js")
    lst[lst.length] = add_script("https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/js/","bootstrap.min.js")

    var script1 = document.createElement("script" )
    lst.forEach( script_or_css => {
        hd.appendChild(script_or_css )        
    });
}

// function adddom_AngularJS_CDN(){
//     /** @type {HTMLHeadElement}  hd  */
//     var hd =  document.head
//     var lst = [] 
//     lst[lst.length] = add_script("https://ajax.googleapis.com/ajax/libs/angularjs/1.7.2/","angular.min.js")

//     var script1 = document.createElement("script" )
//     lst.forEach( script_or_css => {
//         // hd.appendChild(script_or_css )        
//         hd.insertAdjacentElement("afterbegin",script_or_css )        
//     });
// }
